...
Route::get('/caja/crear', ['middleware' => ['auth', 'role:admision|caja|farmacia|laboratorio|imagenes|facturacion|administracion|estadistica|sistemas'],  'as' => 'createManualservice', 'uses' => 'ServicesController@createManual']);

Route::get('/caja/crear/servicio/{input}', ['middleware' => ['auth', 'role:admision|caja|farmacia|laboratorio|imagenes|facturacion|administracion|estadistica|sistemas'],  'as' => 'newservice', 'uses' => 'ServicesController@createService']);
