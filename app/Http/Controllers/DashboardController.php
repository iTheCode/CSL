...
class DashboardController extends BaseController
{
	...
	public function showDashboard()
	{
		...
		$porcentaje_antenciones_mes = round((100*$atenciones_mes)/$atenciones_año_anterior,2);
		...
		$porcentaje_emergencias_mes = round((100*$emergencias_mes )/$emergencias_año_anterior,2);
		...
		$porcentaje_pacientes_mes = round((100*$pacientes_nuevos_mes )/$pacientes_año_anterior,2);
