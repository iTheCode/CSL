                ...
                if (state && init) {
                    ...
                    $.ajax({
                        ...
                        beforeSend:function(){
                          ...
                          $(".nav .navbar-nav .navbar-right .pull-right").html('<li class="hidden-xs"><a href="#" id="loading-gif" class="waves-effect waves-light"><img id="btn-fullscreen" src="/assets/images/heartbeat.gif" width="35px" height="35px"></li></a></li><li class="hidden-xs" style="display:none;"><a href="#" id="btn-fullscreen" class="waves-effect waves-light"><i class="md md-crop-free"></i></a>');
                        ...
                        complete: function(resp){
                          $(".nav .navbar-nav .navbar-right .pull-right").html('<li class="hidden-xs" style="display:none;"><a href="#" id="btn-fullscreen" class="waves-effect waves-light"><i class="md md-crop-free"></i></a>');
