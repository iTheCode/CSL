                                        ...
                                        <div class="panel" style="margin:0 auto;width:450px">
                                            <div class="panel-body">
                                                ...
                                                <div>Fecha de Inicio
                                                    ...
                                                    Elija Médico
                                                    <div class="input-group col-md-12">
                                                        {{ Form::select('doctor_id', [null=>'Seleccione un doctor'] + $doctors, null, ['class' => 'form-control']) }}
                                                    </div><br><br>
                                                    Elija la opción
                                                    <div class="input-group col-md-12">
                                                        <select name="opcion" class="form-control">
                                                            <option value="1">Con Número de Factura</option>
                                                            <option value="2" selected>Sin Número de Factura</option>
                                                        </select>
                                                    </div>
                                                </div>
