            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title"><a href="{{ url('/admision/crear') }}" class="btn btn-primary waves-effect waves-light btn-lg m-b-5" data="address">Nueva Atención</a> </h4>
                    ...
                    $.ajax(
                              {
                                ...
                                progress: function(e) {
                                        ...
                                        $("#load_bar").animate({'width':pct}).show();
                                },
