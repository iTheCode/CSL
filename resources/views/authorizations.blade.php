            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title"><a href="{{ url('/registrar_atencion') }}" class="btn btn-primary waves-effect waves-light btn-lg m-b-5">Registrar Atención</a> </h4>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        @foreach ($users as $user)
                                                            <tr>
                                                                <td>{{ $i++ }}</td>
                                                                <td>{{ $user->intern_code }}</td>
                                                                <td>{{ $user->patient->clinic_history_code }}</td>
                                                                <td>{{ $user->patient->document_identity_code or 'Corregir DNI' }}</td>
                                                                <td><a href="{{ url('/paciente/'.$user->patient->id) }}">{{ $user->patient->name }} {{ $user->patient->paternal }} {{ $user->patient->maternal }}</a></td>
