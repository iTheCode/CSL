                                                    ...
                                                    <table class="table">
                                                        ...
                                                        @foreach ($users as $user)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                  <a href="#" type="button" class="btn btn-icon waves-effect waves-light {{Helpers::get_color(@$user->coverage->sub_coverage_type->coverage_type->id)}} m-b-5" data-toggle="tooltip" data-placement="top" title="" data-original-title="Editar personal" data="address" onclick="open_modal('edit_personal')">Editar</a>
